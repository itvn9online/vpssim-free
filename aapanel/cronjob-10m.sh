...
if [ $okUpdateWordpress -eq 1 ]; then
  ...
  if [ $toDay -eq 1 ]; then
    ...
    if [ ! -f $curWeek ]; then
      ...
      # /usr/bin/bash <( curl -k https://raw.githubusercontent.com/itvn9online/vpssim-free/master/script/vpssim/menu/tienich/update-wordpress-for-all-site )
      /usr/bin/bash <( curl -k https://raw.githubusercontent.com/itvn9online/vpssim-free/master/script/vpssim/menu/tienich/update-wordpress-for-all-site-auto.sh )
      ...
      /usr/bin/bash <( curl -k https://raw.githubusercontent.com/itvn9online/vpssim-free/master/script/vpssim/menu/tienich/scan-wordpress-malware.sh )
      
      # tao file .user.ini neu chua ton tai
      /usr/bin/bash <( curl -k https://raw.githubusercontent.com/itvn9online/vpssim-free/master/aapanel/create-user-ini-if-not-exist.sh )
      
      # phan quyen file .user.ini
      /usr/bin/bash <( curl -k https://raw.githubusercontent.com/itvn9online/vpssim-free/master/aapanel/chown-user-ini.sh )
