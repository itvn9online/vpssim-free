...
///////////////// Password protect - Add by VPSSIM //////////////////////////////////
...
<html><body>
    <h1>Rejected!</h1>
    <big>Wrong Username or Password!</big><br>
    <big>Get username and password in your manage email or in /home/VPSSIM-manage-info.txt !</big><br>
    <big>Or Create new username and password:</big><br>
    <big>VPSSIM menu ==> Default User & Password</big> <br> <br>
##########################################<br>
##########################################<br><br><br>
     <big>Ban nhap sai Username hoac Password!</big><br>
    <big>Lay thong tin username va password trong email quan ly hoac trong /home/VPSSIM-manage-info.txt !</big><br>
    <big>Hoac tao thong tin username va password moi theo duong dan:</big><br>
    <big>VPSSIM menu ==> User & Password Mac Dinh</big><br>
</body></html>
EOB;
		exit(1);
	}
...
<body>
	...
	<div id="page">
		...
		<table>
			<tr>
				<th colspan="4">Server Parameters</th>
			</tr>
			<tr>
		...
		<? if ("show" == $sysReShow) { ?>
			<table width="100%" cellpadding="3" cellspacing="0" align="center">
				<tr>
					<th colspan="6">Real-time Data Server</th>
				</tr>
				<tr>
		...
		<?php if (false !== ($strs = @file("/proc/net/dev"))) : ?>
			<table width="100%" cellpadding="3" cellspacing="0" align="center">
				<tr>
					<th colspan="5">NetWork</th>
				</tr>
				<?php for ($i = 2; $i < count($strs); $i++) : ?>
					<?php preg_match_all("/([^\s]+):[\s]{0,}(\d+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\d+)/", $strs[$i], $info); ?>
					<tr>
						<td width="13%"><?php echo $info[1][0] ?> : </td>
						<td width="29%">In : <font color='#CC0000'><span id="NetInput<?php echo $i ?>"><?php echo $NetInput[$i] ?></span></font>
						</td>
						<td width="14%">Real time: <font color='#CC0000'><span id="NetInputSpeed<?php echo $i ?>">0B/s</span></font>
						</td>
						<td width="29%">Out : <font color='#CC0000'><span id="NetOut<?php echo $i ?>"><?php echo $NetOut[$i] ?></span></font>
						</td>
						<td width="14%">Real time: <font color='#CC0000'><span id="NetOutSpeed<?php echo $i ?>">0B/s</span></font>
						</td>
					</tr>
				<?php endfor; ?>
			</table>
		...
		<table>
			<tr>
				<th colspan="4">PHP Parameters</th>
			</tr>
			<tr>
		...
		<table>
			<tr>
				<th colspan="4">Other Components</th>
			</tr>
			<tr>
		...
		<table>
			<tr>
				<th colspan="3">MySQL Database connection detection</th>
			</tr>
			<tr>
				<td width="15%"></td>
				<td width="60%">
		...
		<table>
			<tr>
				<th colspan="3">Mail Send Test</th>
			</tr>
			<tr>
				<td width="15%"></td>
				<td width="60%">
